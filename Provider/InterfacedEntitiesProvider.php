 ...
 */
class InterfacedEntitiesProvider implements DoctrineEntityProvider
{
    /** @var Registry */
    ...
    public function getAllEntities()
    {
        ...
        foreach($managers as $em)
        {
            ...
            foreach($classes as $class)
            {
                ...
                if($this->classHasInterface(new \ReflectionClass($class)))
                {
    ...
    protected function classHasInterface(\ReflectionClass $class)
    {
